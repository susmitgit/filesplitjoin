	...
	public static void main(String args[]) {
		...
		if (args.length == 0) {
			...
			if (args[0].equals("-h")) {
				...
				System.out.println("java fileSplitJoin -s <filepath> <Split file size in Mb>");
				System.out.println("----------------------------------------------------------------");
				System.out.println("For Joining The Splitted File:");
				System.out.println("java fileSplitJoin -j <Path To file.sp>");
				System.out.println("----------------------------------------------------------------");
		...
		else if((args.length == 3) && args[2].startsWith("-"))
		{
			...
			System.out.println("Type \"fileSplitJoin -h\" for Help!");
